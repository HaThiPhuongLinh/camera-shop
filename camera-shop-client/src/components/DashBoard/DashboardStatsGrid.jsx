...
export default function DashboardStatsGrid() {
  ...
  useEffect(() => {
    ...
    orderApi
      .getSalesReport("2024-07", currentMonthYear)
      .then((response) => {
    ...
    <div className="flex gap-4">
      ...
      <BoxWrapper>
        ...
        <div className="pl-4">
          ...
          <div className="flex items-center">
            <strong className="text-xl text-gray-700 font-semibold">
              ${salesReport.totalExpenses.toFixed(2)}
            </strong>
          </div>
        </div>
      </BoxWrapper>
      <BoxWrapper>
        ...
        <div className="pl-4">
          <span className="text-sm text-gray-500 font-normal">Total Profit</span>
          <div className="flex items-center">
            <strong className="text-xl text-gray-700 font-semibold">
            ${salesReport.profit.toFixed(2)}
            </strong>
          </div>
        </div>
      </BoxWrapper>
